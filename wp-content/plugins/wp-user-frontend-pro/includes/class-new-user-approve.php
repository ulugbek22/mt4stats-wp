...
class WPUF_New_User_Approve {
        ...
        <tr>
            ...
            <td>
                <label>
                    ...
                    <input type="checkbox" id="wpuf_new_user_status" name="wpuf_settings[wpuf_user_status]" value="pending"<?php checked( $status_selected, 'pending' ); ?>>

                    <?php _e( 'Require approval', 'wpuf-pro' ); ?>
                </label>

                <p class="description"><?php _e( 'If enabled registered user cannot login until approved by an admin', 'wpuf-pro' ); ?></p>
            </td>
        </tr>
        <?php
    }
    ...
    public function get_authentication_message( $status ) {
        ...
        $default_pending_msg = __( '<strong>ERROR:</strong> Your account has to be approved by an administrator before you can login.', 'wpuf-pro' );
        $default_denied_msg = __( '<strong>ERROR:</strong> Your account has been denied by an administrator, please contact admin to approve your account.', 'wpuf-pro' );
    ...
    public function add_global_settings( $settings_fields ) {
        ...
        $settings_fields['wpuf_profile'][] = array(
            ...
            'default'  => __( '<strong>ERROR:</strong> Your account has been denied by an administrator, please contact admin to approve your account.', 'wpuf-pro' ),
            'type'     => 'textarea',
        );
